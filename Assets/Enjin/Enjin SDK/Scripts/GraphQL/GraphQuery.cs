...
namespace GraphQLClient
{
    public class GraphQuery : MonoBehaviour
    {
        ...
        public static void POST(string details) { POST(details, "", false); }
        public static void POST(string details, string token) { POST(details, token, false); }
        public static void POST(string details, bool async) { POST(details, "", async); }
        public static void POST(string details, string token, bool async)
        {
            ...
            else
            {
                if (async)
                {
                    instance.StartCoroutine(WaitForRequest(request));
        ...
        static IEnumerator WaitForRequest(UnityWebRequest data)
        {
            yield return data;
