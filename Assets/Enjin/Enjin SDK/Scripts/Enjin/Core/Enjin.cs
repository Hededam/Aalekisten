namespace EnjinSDK
{
    ...
    public class Enjin
    {
        ...
        public static Request MintFungibleItem(int senderID, string[] addresses, string itemID, int value) { return _requests.MintFungibleItem(senderID, addresses, itemID, value); }
        public static Request MintFungibleItem(int senderID, string[] addresses, string itemID, int value, System.Action<RequestEvent> callback)
        {
            Request request = MintFungibleItem(senderID, addresses, itemID, value);
            RequestCallbacks.Add(request.id, callback);
            return request;
        }
        public static Request MintNonFungibleItem(int senderID, string[] addresses, string itemID) { return _requests.MintNonFungibleItem(senderID, addresses, itemID); }
        ...
        public static Request SendCryptoItemRequest(int identityID, string tokenID, int recipientID, int value) { return _requests.SendItem(identityID, tokenID, recipientID, value); }
        public static Request SendBatchCryptoItems(CryptoItemBatch items, int userID) { return _requests.SendItems(items, userID); }
        public static Request MeltTokens(int userIdentityID, string itemID, string index, int amount, System.Action<RequestEvent> callback) { return _requests.MeltItem(userIdentityID, itemID, index, amount, callback); }
        public static Request MeltTokens(int userIdentityID, string itemID, int amount, System.Action<RequestEvent> callback) { return _requests.MeltItem(userIdentityID, itemID, "", amount, callback); }
        ...
        public static Request SendCryptoItemRequest(int identityID, string tokenID, int recipientID, int value, System.Action<RequestEvent> callback)
        {
            return _requests.SendItem(identityID, tokenID, recipientID, value, callback);
        }
        ...
        public static void Post(string details, string token) { GraphQuery.POST(details, token, false); }
        public static void Post(string details) { GraphQuery.POST(details, "", false); }
