...
public class WalletTab
{
    ...
    private void UnlinkedWallet()
    {
        ...
        if (GUILayout.Button(new GUIContent("Enjin Wallet Android"), GUILayout.Width(140), GUILayout.Height(30)))
            Application.OpenURL("https://drive.google.com/open?id=17l8pSm2_1m8VF7dH1p9TIdjZDjSja4Tt");
